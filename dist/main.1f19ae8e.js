...
var player = {
  ...
  init: function init() {
    ...
    player.ui.writeStyle.innerText = _css.default.substr(0, player.n);
    player.bindEvents();
    player.play();
  },
  ...
  run: function run() {
    ...
    player.ui.writeStyle.innerHTML = _css.default.substr(0, player.n);
  },
  play: function play() {
...
player.init();
},{"./css":"css.js"}],"C:/Users/lenovo/AppData/Local/Yarn/Data/global/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
